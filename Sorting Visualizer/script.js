...
let hf = 20;
let n = 0;
let aahil = document.getElementById('ans');
...
//         unsorted_array[i] = random_num(min_range,max_range)    
//     }
...
async function bubbleSort(array) {
  //let aahil = document.getElementsByClassName('ans');
    ...
    aahil.innerHTML = "Time Complexity: ";
    aahil.innerHTML += array.length * array.length + " iterations";
    return array;
  }
...
async function CountSort(a){
 ...
 // let bars1 = document.getElementsByClassName('bar1');
  ...
  // count1 = count;
  // renderBars(count1);
  // console.log("count array bars generated!");
  ...
  aahil.innerHTML = "Time Complexity: "
  aahil.innerHTML += a.length + range + " iterations";
  console.log(a);
  }
//Radix Sort
async function RadixSort(arr)
{
    ...
    aahil.innerHTML += n*d + " iterations";
}
...
async function InsertionSort(array) {
  ...
  async function HeapSort(array) {
    ...
    aahil.innerHTML = "Time Complexity: ";
    aahil.innerHTML += array.length * Math.log2(array.length) + " iterations";
    return array;
  }
  ...
  async function mergeSort(arr) {
    ...
    while (i < left.length && j < right.length) {
      if (left[i] < right[j]) {
        ...
        arr[k] = right[j];
        j++;
        // bars[k + middle].style.height = arr[k] * hf + "px";
    ...
    aahil.innerHTML = s + arr.length * Math.log2(arr.length) + " iterations";
    return arr;
  }
...
function CountSort1(array)
{
  console.log("New 2 algorithm working");
    ...
    if(a && b)
    {
        ...
        {
            aahil.style.color = "red";
            aahil.innerHTML = "Enter correct range";
        }
        else
        {
            ...
            aahil.style.color = "white";
            aahil.innerHTML = "Number of elements in this range: " + val;
    ...
    {
        aahil.style.color = "white";
        aahil.innerHTML = "Input Empty. Pleas Enter Range!";
    }
  ...
  sort_btn.addEventListener("click", function () {
    switch (algo) {
      ...
      case "insertion":
        ...
        aahil.innerHTML = "Time Complexity: "
        aahil.innerHTML +=  unsorted_array.length * unsorted_array.length  + " iterations";
        break;
      case "quick":
        quickSort(unsorted_array, 0, unsorted_array.length - 1);
        aahil.innerHTML = "Time Complexity: ";
        aahil.innerHTML += unsorted_array.length * Math.log2(unsorted_array.length) + " iterations";
        break;
      case "count":
      ...
      case "new1":
        ...
        var range = max - min + 1;
        aahil = document.getElementById("ans");
        aahil.innerHTML = "Time Complexity: ";
        aahil.innerHTML += unsorted_array.length * range + unsorted_array.length * Math.log2(unsorted_array.length/range) + " iterations";
